        ...
        <article className="login-hero">
          ...
          <div className="login-hero-grid">
            ...
            <article className="login-stat-card">
              ...
              <p>Luu token dang nhap va dieu huong dung role cho admin, user va host.</p>
            </article>
          </div>
        </article>
        ...
        <article className="login-card">
          ...
          {registeredEmail ? (
            <div className="login-verification-box">
              ...
              <p>
                Tai khoan moi cua ban da duoc tao cho <strong>{registeredEmail}</strong>. Neu
                chua thay thu, ban co the gui lai email xac nhan ngay tai day.
              </p>
