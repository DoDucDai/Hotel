  ...
  return (
    <main className="account-page">
      <section className="account-shell">
        ...
        {loading ? (
          <div className="account-loading">Dang tai du lieu tai khoan...</div>
        ) : loadError ? (
          ...
          <>
            ...
            {activeTab === "profile" ? (
              <section className="account-card profile-card">
                ...
                <div className="profile-section">
                  ...
                  <p className="card-note">
                    Doi email dang nhap. He thong se cap token moi ngay sau khi doi.
                  </p>
            ...
            {activeTab === "history" ? (
              <section className="account-card account-history-card">
                ...
                {bookingsLoading ? (
                  <div className="account-loading compact">Dang tai lich su dat phong...</div>
                ) : bookingsError ? (
                  <div className="account-error compact">{bookingsError}</div>
                ) : sortedBookings.length === 0 ? (
                  <div className="account-loading compact">
                    Ban chua co booking nao. Hay dat phong tu danh sach khach san.
                  </div>
                ) : (
            ...
            {activeTab === "wishlist" ? (
              <section className="account-card">
                ...
                {wishlistLoading ? (
                  <div className="account-loading compact">Dang tai wishlist...</div>
                ) : wishlistError ? (
                  <div className="account-error compact">{wishlistError}</div>
                ) : wishlistItems.length === 0 ? (
                  <div className="account-loading compact">
                    Ban chua luu khach san nao. Hay vao trang hotels de them vao wishlist.
                  </div>
                ) : (
                    ...
                    {wishlistItems.map((item) => {
                      ...
                      return (
                        <article key={item.hotelId} className="wishlist-card">
                          <p className="wishlist-city">{hotel.city || "Dia diem noi bat"}</p>
