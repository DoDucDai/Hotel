    ...
    <main className="hotels-page">
      <section className="hotels-container hotels-hero">
        <div className="hotels-hero-content">
          ...
          <p>
            Ngoai tim theo dia diem va lich o, ban co the loc sau hon theo muc gia, diem
        ...
        <div className="toolbar-grid toolbar-grid-main">
          <label className="filter-field">
            ...
            <input
              ...
              placeholder="Nhap ten khach san, thanh pho hoac dia chi"
            />
          </label>
        ...
        <div className="toolbar-grid toolbar-grid-sub">
          ...
          <label className="filter-field">
            ...
            <select value={sortBy} onChange={(event) => setSortBy(event.target.value)}>
              ...
              <option value="city-asc">Thanh pho A - Z</option>
              <option value="city-desc">Thanh pho Z - A</option>
        ...
        <div className="toolbar-grid toolbar-grid-advanced">
          ...
          <label className="wishlist-checkbox">
            <input
              ...
              disabled={!isLoggedIn}
            />
            <span>Chi xem wishlist cua toi</span>
          </label>
        </div>
      ...
      <section className="hotels-container hotels-results">
        {loading ? (
          ...
          <div className="result-state empty-state">
            Khong tim thay khach san nao theo bo loc hien tai.
          </div>
        ) : (
              ...
              >
                ...
                <div className="hotel-body">
                  ...
                  <p className="hotel-address">
                    {hotel.address || "Dia chi dang duoc cap nhat"}
                  </p>
